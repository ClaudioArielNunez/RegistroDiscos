...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mb-2 row">
        <div class="">
            <asp:GridView ID="dgvLista" AutoGenerateColumns="false" CssClass="table table-bordered table-hover" runat="server">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText ="Acciones - CRUD">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton CommandArgument="" cssClass="btn btn-sm btn-success" ID="btnUpdate" runat="server" >Update</asp:LinkButton>
